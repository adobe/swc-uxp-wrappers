...
-   For detailed README regarding `@spectrum-web-components/help-text` [refer this link](https://www.npmjs.com/package/@spectrum-web-components/help-text/v/1.12.1)
