...
import { DialogWrapper } from '@swc-uxp-internal/dialog/src/DialogWrapper.js';

import styles from './uxp-dialog-base.css.js';

class UxpDialogWrapper extends DialogWrapper {
    static get styles() {
...
export { UxpDialogWrapper as DialogWrapper };
