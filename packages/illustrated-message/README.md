...
-   For detailed README regarding `@spectrum-web-components/illustrated-message` [refer this link](https://www.npmjs.com/package/@spectrum-web-components/illustrated-message/v/1.12.1)
